    ...
    <div className='card-container text-white'>
      <div className='inside'>
        <div className='basic-info general-border'>
          <div className='ft-s-24'>{props.data.name}</div>
          <div className='flex'>
            <img src={address} alt="" />
            <span className='ml-10 ft-s-14 bg-grey text-gray addr'>{addr}</span>
          </div>
          <div className='intro mt-5'>{props.data.introduction}</div>
        </div>
        ...
        <div className='skills general-border'>
          <div className='ft-s-16 fw-700'>Skills</div>
      ...
      <div className='awsome-things general-border mt-8'>
        <div className='awsome-things-title ft-s-16 fw-700'>Awesome Things</div>
        {props.data.awesome_things.map((item) => {
          return <div className='border-t p-8 fw-700 ft-s-12 flex'>
      ...
      <div className='awsome-things general-border mt-8 pb-20'>
        <div className='awsome-things-title ft-s-16 fw-700 border-b'>Project Whitelist</div>
        <div className='p-8'>
          {props.data.project_whitelist.map((item) => {
            return <div className='project-item pointer mr-8 ft-s-12'>
              {item.project}
            </div>
          })}
        </div>
      ...
      <div className='awsome-things general-border mt-8'>
        <div className='awsome-things-title ft-s-16 fw-700'>DAO/Organization</div>
        <div className='dao-list'>
          {props.data.organization.map((item) => {
            return <div className='flex border-t pt-4 pl-4'>
              ...
              <div className=''>
                <div className='dao-name ft-s-24 ft-700 mb-10'>{item.name}</div>
                {item.is_core_member ? <div className='flex position'>
