...
export default function index({ text, width, height = 'sm' }: Props) {
  return <div className={`flex-grow border border-[#79D5A880] border-solid hover:border-0 flex flex-col justify-center items-center font-IBMPlexMono text-[14px]
      ${width === 'full' && 'w-full'}
      ${height === 'sm' && 'h-[26px]'}
      ${height === 'md' && 'h-[86px]'}
      ${height === 'lg' && 'h-[142px]'}
