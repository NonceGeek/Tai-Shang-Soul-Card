  ...
  return (
    <div className='card-container-dao text-white relative'>
      ...
      <div className='card-padding'>
        ...
        <div className='flex'>
          <img src={address} alt="" />
          <span className='ml-[10px] ft-s-14 bg-grey text-gray addr word-break'>{addr}</span>
        </div>
        <div className='inside text-ibm mt-[8px]'>
          ...
          <div className='contract general-border flex pr-[14px] pl-[14px]'>
            <img src={sign} alt="" />
            <span className='ml-[4px] word-break'>{cardData.contract_address}</span>
          </div>
        ...
        <div className='awsome-things general-border mt-[8px]'>
          ...
          {cardData.awesome_things.map((item) => {
            return <div className='border-t p-[8px] fw-700 text-ibm ft-s-12 flex' key={item.project}>
        ...
        <div className='awsome-things general-border mt-[8px]'>
          ...
          <div className='dao-list'>
            {coreMember.map((item, index) => {
              return <div className='flex pt-[4px] pl-[8px] mb-[15px]' key={index}>
                <div><img src={require(`./mock/${item.avator}.png`)} alt="" /></div>
                <div className='ml-[10px]'>
                  <div className='dao-name ft-s-14 ft-700 mb-[5px] line-height-one text-ibm-bold word-break'>{item.name}</div>
          ...
          <div className='' style={{borderTop: '.5px solid #ffffff'}}>
              <div className='m-icon m-[8px]'><img src={m} alt="" /></div>
        ...
        <div className='awsome-things general-border mt-[8px]'>
          ...
          <div className='partner'>
            {cardData.partner.map((item, index) => {
              return <div className='flex border-t p-[8px] dao-ele' key={index}>
                <img src={require(`./mock/${item.avator}.png`)} alt="" />
