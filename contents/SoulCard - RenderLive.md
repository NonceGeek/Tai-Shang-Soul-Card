...
`template` 是合法的 Heex 模板或者 HTML 文件就可以了。`SoulCardRenderLive` 是从 `assigns.template_gist_id` 指定的 Gist 读取的。可以参考这个样例：https://gist.github.com/leeduckgo/1a301c084577fde54df73ced3139a3cb
